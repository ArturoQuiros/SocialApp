...
const DropdownHeader = ({ children, ...props }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { className: "block py-2 px-4 text-sm text-gray-700 dark:text-gray-200", ...theirProps, children: children }), (0, jsx_runtime_1.jsx)(DropdownDivider_1.DropdownDivider, {})] }));
};
