...
const ToastToggle = ({ xIcon: XIcon = hi_1.HiX }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("button", { "data-testid": "toast-toggle-element", type: "button", className: theme.base, onClick: handleClick, "aria-label": "close", children: (0, jsx_runtime_1.jsx)(XIcon, { className: theme.icon }) }));
};
