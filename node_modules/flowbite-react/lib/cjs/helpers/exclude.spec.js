...
(0, vitest_1.describe)('Helpers / Exclude (delete key from object)', () => {
    (0, vitest_1.describe)('Given object that contains targeted key', () => {
    ...
    (0, vitest_1.describe)('Given object that does not contain target key', () => {
